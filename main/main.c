...
esp_spp_cb_param_t *bt_connection_param;
char test[100];
int test_counter = 0;
bool is_open = false;
...
static void esp_spp_cb(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
    ...
    case ESP_SPP_DATA_IND_EVT:
        ...
        process_bluetooth_data(param , param->data_ind.data , param->data_ind.len);
...
#ifdef BLUETOOTH_DB
        ESP_LOGI(SPP_TAG, "ESP_SPP_WRITE_EVT: %d" , param->start.handle);
#endif        
        break;
    case ESP_SPP_SRV_OPEN_EVT:
        ...
        // is_open = true;
        // sprintf(test , "on");        
        // esp_spp_write(param->write.handle , strlen(test) , (uint8_t *) test); 
